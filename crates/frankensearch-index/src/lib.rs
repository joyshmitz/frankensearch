...
pub use simd::{
    ...
    pack_f16_le_bytes_to_4bit_scalar_pack, pack_f16_slab_to_4bit, pack_f16_slab_to_4bit_generic,
    prepare_4bit_query, quantize_f16_le_bytes_to_i8, quantize_f16_le_bytes_to_i8_generic,
