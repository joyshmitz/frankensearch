...
- **Native MiniLM producer identity also changes with Tokenizers 0.23.2.** The dependency protocol update changes the F32 native producer fingerprint while preserving its embedding space and numerical certificate. An earlier producer still requires explicit compatibility admission; strict fsfs admission requires rebuilding its semantic index. Historical and current fingerprints are pinned separately in the regression tests. [Protocol update](https://github.com/Dicklesworthstone/frankensearch/commit/520164439ff4cbc55573d1c79d2346e313fc778f); [historical identity regression](https://github.com/Dicklesworthstone/frankensearch/commit/9cd2b3652a9cca5ec74dde6c7cdcfe00b98bc646).
